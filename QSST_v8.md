...
本理論は、クオリアを社会的協調の機能要請から生じる構造的産物として再定義し、検証可能な予測モデルを提供する。本理論においてクオリアとは、(i) 多主体協調の必然性、(ii) 内部状態の主観的評価に関わる不可逆的圧縮、(iii) 較正不能性（当事者制約下でのGround Truthへのアクセス不能性）という三つの構造的制約のもとで、行動予測を可能にするために収束した内部インターフェースである。
...
**棄却条件**：共有・較正帯域を有意に増大させても、これら指標に系統的な減衰が見られない、**または逆方向の系統的変化が見られる**場合、本予測は支持されない。
